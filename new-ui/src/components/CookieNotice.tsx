...
export function CookieNotice({ onPrivacy }: { onPrivacy: () => void }) {
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 text-sm text-gray-700 font-sans">
        ...
        <button
          type="button"
          onClick={dismiss}
          className="shrink-0 bg-[#141414] text-white px-4 py-2 font-mono text-xs uppercase font-bold tracking-wider hover:bg-[#FF3300] transition-colors"
        >
          OK
        </button>
      </div>
